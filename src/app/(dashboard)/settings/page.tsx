...
export default async function SettingsPage() {
  ...
  // Espace de paramétrage réservé au superadmin : un utilisateur (qui peut
  // tout faire par ailleurs) est renvoyé au tableau de bord.
  if (session.user.role !== "superadmin") {
    redirect("/");
  }

  // Le journal contient qui a lu quel mot de passe et qui a agi sur quel
  // équipement — d'où sa place ici.
    ...
    <div className="p-6 lg:p-8 space-y-8">
      <div>
        ...
        <p className="text-[#8896b4] mt-1 text-sm">
          Espace superadmin — accès à la plateforme, agents, accès programmatique et traçabilité
        </p>
      </div>
